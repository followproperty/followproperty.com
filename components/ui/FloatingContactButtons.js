...
export default function FloatingContactButtons() {
  ...
  return (
    <AnimatePresence>
      <motion.div 
        className="fixed bottom-6 right-6 z-50 flex flex-col gap-3.5 select-none pointer-events-auto"
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        <motion.a
          ...
          whileHover="hover"
          whileTap="tap"
          className="group relative flex items-center justify-center w-[52px] h-[52px] rounded-full bg-brand-navy text-white shadow-[0_4px_16px_rgba(15,22,41,0.25)] hover:bg-brand-blue transition-colors duration-300"
        ...
        <motion.a
          ...
          whileHover="hover"
          whileTap="tap"
          className="group relative flex items-center justify-center w-[52px] h-[52px] rounded-full bg-[#25D366] text-white shadow-[0_4px_16px_rgba(37,211,102,0.35)] hover:bg-[#20ba5a] transition-colors duration-300"
