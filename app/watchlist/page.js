        ...
        <div className="max-w-6xl mx-auto py-8">
          <div className="flex justify-between items-center mb-8 animate-pulse">
            <div className="space-y-2">
              <div className="h-8 w-44 bg-brand-bgAlt rounded-lg" />
              <div className="h-4 w-72 bg-brand-bgAlt rounded-lg" />
            </div>
            <div className="h-10 w-36 bg-brand-bgAlt rounded-xl" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-8 animate-pulse">
            {[1, 2, 3, 4].map(i => (
              <div key={i} className="h-24 bg-brand-bgCard rounded-2xl border border-brand-border" />
            ))}
          </div>
          <div className="h-[200px] bg-brand-bgCard rounded-2xl border border-brand-border animate-pulse mb-8" />
          <div className="h-[350px] bg-brand-bgCard rounded-2xl border border-brand-border animate-pulse" />
        </div>
      </DashboardLayout>
    );
  }
      ...
      <div className="max-w-6xl mx-auto pb-12">
        ...
        <div className="bg-brand-bgCard p-6 rounded-3xl border border-brand-border shadow-brand mb-8 animate-in fade-in slide-in-from-top-3">
          ...
          {(latestWatchlist.preApprovedBank || latestWatchlist.loanAmount || latestWatchlist.downPayment) && (
            <div className="mt-6 pt-5 border-t border-brand-border/60 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-3 bg-brand-bgAlt rounded-xl border border-brand-border flex items-center gap-3">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-5">
            ...
            {properties.length > 0 && (
              <span className="text-xs font-semibold text-brand-teal bg-brand-tealBg px-2.5 py-1 rounded-full border border-brand-tealBorder">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {/* Compare Capability */}
          <div className="bg-brand-bgCard p-6 rounded-3xl border border-brand-border shadow-brand flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 mb-3 pb-3 border-b border-brand-border">
                <GitCompare size={18} className="text-brand-teal" />
            ...
            <div className="pt-2">
              <span className="text-[10px] font-bold uppercase tracking-wider bg-brand-tealBg text-brand-tealDark px-2.5 py-1 rounded border border-brand-tealBorder">
